...
# load in the music #
bckgnd_music = mixer.music.load("sounds/bckgnd_music.mp3")
...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        ...
        if len(self.bullets) < self.settings.bullets_allowed:
            ...
            # Causes the fired bullet to play a sound
            # only when there are bullets fired
            bullet_sound.play()
    ...
    def _update_bullets(self):
        ...
        # Update position and get rid of bullets that disappeared # 
